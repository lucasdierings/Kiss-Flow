/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: af26cf8302ed1f1daf0a904bd3990e6c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ALLOWED_EMAILS" | "GEMINI_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "REVENUECAT_WEBHOOK_AUTH_KEY" | "APPLE_CLIENT_ID" | "APPLE_CLIENT_SECRET" | "APPLE_PRIVATE_KEY" | "APPLE_TEAM_ID" | "APPLE_KEY_ID">> {}
}
