...
const kpis = [
  ...
  },
  {
    ...
    trend: "+0.8m",
    trendUp: true,
    desc: "Previsao de duracao do encanto",
    color: "#059669",
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
  ...
  {
    label: "Prof. Regressao",
    value: "42%",
    target: "Moderada",
    trend: "+8%",
    trendUp: true,
    desc: "Linguagem infantil/dependente",
    color: "#d97706",
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
  ...
  },
  {
    ...
    trend: "+0.12",
    trendUp: true,
    desc: "Espelhamento linguistico detectado",
    color: "#06b6d4",
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
